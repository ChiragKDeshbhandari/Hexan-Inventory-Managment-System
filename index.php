					...
					<form>
					  <div class="form-row">
						...
						<div class="form-group col-md-3">
						  ...
						  <input type="text" class="form-control datepicker" id="purchaseDetailsPurchaseDate" name="purchaseDetailsPurchaseDate" readonly value="2022-09-18">
						</div>
						<div class="form-group col-md-2">
				...
				<div class="card card-outline-secondary my-4">
				  ...
				  <div id="vendorDetailsMessage"></div>
					 <form> 
					  ...
					  <div class="form-row">
						<div class="form-group col-md-6">
						  <label for="vendorDetailsVendorPinCode">PinCode</label>
						  <input type="text" class="form-control" id="vendorDetailsVendorPinCode" name="vendorDetailsVendorPinCode">
						</div>
						<div class="form-group col-md-4">
					...
					<form>
					  ...
					  <div class="form-row">
						  ...
						  <div class="form-group col-md-3">
							  ...
							  <input type="text" class="form-control datepicker" id="saleDetailsSaleDate" value="2022-09-18" name="saleDetailsSaleDate" readonly>
						  </div>
					  </div>
					  <div class="form-row">
						<div class="form-group col-md-2">
				...
				<div class="card card-outline-secondary my-4">
				  ...
				  <div id="customerDetailsMessage"></div>
					 <form> 
					  ...
					  <div class="form-row">
						<div class="form-group col-md-6">
						  <label for="customerDetailsCustomerPinCode">PinCode</label>
						  <input type="text" class="form-control" id="customerDetailsCustomerPinCode" name="customerDetailsCustomerPinCode">
						</div>
						<div class="form-group col-md-4">
							...
							<form> 
							  <div class="form-row">
								  <div class="form-group col-md-3">
									...
									<input type="text" class="form-control datepicker" id="saleReportStartDate" value="2022-09-18" name="saleReportStartDate" readonly>
								  </div>
								  <div class="form-group col-md-3">
									<label for="saleReportEndDate">End Date</label>
									<input type="text" class="form-control datepicker" id="saleReportEndDate" value="2022-09-18" name="saleReportEndDate" readonly>
								  </div>
							  </div>
							...
							<form> 
							  <div class="form-row">
								  <div class="form-group col-md-3">
									...
									<input type="text" class="form-control datepicker" id="purchaseReportStartDate" value="2022-09-18" name="purchaseReportStartDate" readonly>
								  </div>
								  <div class="form-group col-md-3">
									<label for="purchaseReportEndDate">End Date</label>
									<input type="text" class="form-control datepicker" id="purchaseReportEndDate" value="2022-09-18" name="purchaseReportEndDate" readonly>
								  </div>
							  </div>
